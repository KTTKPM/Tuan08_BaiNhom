...
**Xử lý:**
* Khi checkout: Giảm tồn kho trực tiếp trên Data Grid
* Không gọi DB
...
| PU1 – Product | **192.168.?.?:8081** |
| PU2 – Cart | **192.168.?.?:8082** |
| PU3 – Order | **192.168.?.?:8083** |
| PU4 – Inventory | **192.168.?.?:8084** |
...
4.  Order PU:
    * Lấy cart từ Redis
    * Gọi Inventory (hoặc trực tiếp Redis)
    * Giảm stock
